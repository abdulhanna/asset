    ...
    <>
      <div className="w-full lg:h-screen lg:flex">
        <div className="flex flex-col lg:flex-row">
          <div className="px-[108px] pt-[168px] bg-[#F1F5FD] flex flex-col gap-[95px]">
            <p className="w-[409px]  2xl:w-[525px] text-[20px] leading-[28px] 2xl:leading-8 font-light xl:font-[700] 2xl:font-light text-center">
          ...
          <div className="flex items-center ms-[40px] xl:ms-[120px] 2xl:ms-[240px]">
            <form
              ...
              className="w-[344px] xl:w-[488px] 2xl:w-[700px] flex flex-col">
              <div className="mb-[52px]">
                ...
                <p className="text-base font-normal text-[#121212]">
                  We have send an email with the verification link on the email
                  address mentioned below. We need you Email for security and to
                  keep technical communication.
                </p>
              </div>
