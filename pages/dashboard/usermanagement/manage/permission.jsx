        ...
        <MainLayout User={user}>
             <div>
               ...
               <div className='my-10'>
                   ...
                   <TextField className='w-1/4' label='Module Name' value={permission.moduleName} onChange={(e)=> setPermission({...permission,moduleName:e.target.value})}/>
               ...
               <div className='space-y-6'>
                   ...
                   <PermissionToggle label="VIEW" value={'read'} status={permission.read} handleClick={(e)=> handleToggle(e)}/>
                   <PermissionToggle label="EDIT" value={'readWrite'} status={permission.readWrite} handleClick={(e)=> handleToggle(e)}/>
                   <PermissionToggle label="ACTION" value={'actions'} status={permission.actions} handleClick={(e)=> handleToggle(e)}/>
                   </div>
               </div>
